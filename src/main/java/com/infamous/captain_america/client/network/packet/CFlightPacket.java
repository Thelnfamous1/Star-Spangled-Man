...
public class CFlightPacket {
    ...
    public static CFlightPacket decodePacket(FriendlyByteBuf packetBuffer){
    ...
    public static void encodePacket(CFlightPacket packet, FriendlyByteBuf packetBuffer){
